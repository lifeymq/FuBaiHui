...
public abstract class BaseFragmentMvp<M extends ICommonModel> extends BaseFragment implements
    ICommonView {
   ...
   public void onFailed(int whichApi, Throwable failedResult) {
      showLog("错误接口是：" + whichApi + ":" + failedResult != null ? failedResult.getMessage() :
          "错误原因未知");
   }

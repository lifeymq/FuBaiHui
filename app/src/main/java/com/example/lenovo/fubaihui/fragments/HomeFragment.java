...
//   RecyclerView mMyrec;
   ...
   public void initView() {
      ...
      changeImageSize();
      mMybtnshop1.setChecked(true);

      //        mMytab.addTab(mMytab.newTab().setIcon(R.drawable.home_page_fbh_store).setText
      // ("福百惠商城"));
      //        mMytab.addTab(mMytab.newTab().setIcon(R.drawable.home_page_silver_store).setText
      // ("银积分商城"));
      //        mMytab.addTab(mMytab.newTab().setIcon(R.drawable.home_page_search_vip).setText
      // ("搜索会员"));
      //        mMytab.addTab(mMytab.newTab().setIcon(R.drawable.home_page_join_us).setText
      // ("加盟商家"));
